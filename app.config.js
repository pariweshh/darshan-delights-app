...
export default {
  expo: {
    ...
    ios: {
      ...
      buildNumber: "1",
      associatedDomains: [
        "applinks:darshandelights.com.au",
        "applinks:www.darshandelights.com.au",
      ],
      entitlements: {
        "aps-environment": IS_PRODUCTION ? "production" : "development",
        "com.apple.developer.in-app-payments": ["merchant.com.darshandelights"],
      },
      splash: {
        image: "./assets/images/splash.png",
        resizeMode: "contain",
    ...
    android: {
      package: "com.darshandelights.app",
      versionCode: 1,
      adaptiveIcon: {
      ...
      intentFilters: [
        {
          ...
          data: [
            {
              scheme: "https",
              host: "darshandelights.com.au",
              pathPrefix: "/shop/products",
            },
            {
              scheme: "https",
              host: "darshandelights.com.au",
            ...
            {
              scheme: "https",
              host: "www.darshandelights.com.au",
              pathPrefix: "/shop/products",
            },
            {
              scheme: "https",
    ...
    plugins: [
      ...
      [
        ...
        {
          faceIDPermission:
            "Allow Darshan Delights to use Face ID for secure authentication",
        },
      ],
      "expo-secure-store",
      "expo-font",
    ...
    extra: {
      router: {},
      eas: {
        projectId: "d9dcf810-5b8e-4698-992a-f11a300d8f38",
      },
    },
